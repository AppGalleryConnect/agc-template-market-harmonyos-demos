...
| 首页                                                                   | 我的                                                                   |
| ---------------------------------------------------------------------- | ---------------------------------------------------------------------- |
| ![首页](./LifestyleAndServiceTemplate/LifeBeauty/screenshots/首页.jpg) | ![我的](./LifestyleAndServiceTemplate/LifeBeauty/screenshots/我的.jpg) |
...
| 首页                                               | 我的                                               |
| -------------------------------------------------- | -------------------------------------------------- |
| ![截图](./EducationTemplate/SchoolLife/doc/1.jpeg) | ![截图](./EducationTemplate/SchoolLife/doc/2.jpeg) |
...
| 首页                                                           | 会员                                                          | 我的                                                           |
| -------------------------------------------------------------- | ------------------------------------------------------------- | -------------------------------------------------------------- |
| ![首页](./KidsTemplate/ChildrenEducation/screenshots/home.png) | ![会员](./KidsTemplate/ChildrenEducation/screenshots/Vip.png) | ![我的](./KidsTemplate/ChildrenEducation/screenshots/mine.png) |
...
| 首页                                                                         | 门店                                                                      | 我的                                                                |
| ---------------------------------------------------------------------------- | ------------------------------------------------------------------------- | ------------------------------------------------------------------- |
| ![打卡](./BusinessTemplate/EnterpriseRecruitment/pictures/首页-企业生活.jpg) | ![待办](./BusinessTemplate/EnterpriseRecruitment/pictures/职位列表页.jpg) | ![日程](./BusinessTemplate/EnterpriseRecruitment/pictures/我的.jpg) |
